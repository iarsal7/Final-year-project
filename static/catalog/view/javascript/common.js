...
$(document).ready(function() {
     ...
     * Written by Romit Sachani, March 2019
     */  
    // madebyhand Search Start 
		...
		$.ajax({
			...
			success: function(json) {
                ...
                if (json.success) {
                    ...
                    setTimeout(function() {
  $('#cart > button').html('<span class="svgbg"><svg><use xlink:href="#hcart"></use></svg></span><div class="shop-c text-left"><span id="cart-total">' + json['total'] + '</span></div>')
                    }, 100);
